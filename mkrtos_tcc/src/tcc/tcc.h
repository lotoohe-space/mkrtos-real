...
#else
# define CONFIG_TCC_BACKTRACE 0 /* enable builtin stack backtraces */
#endif

#if defined CONFIG_TCC_BCHECK && CONFIG_TCC_BCHECK==0
#  undef CONFIG_TCC_BCHECK
#else
#  define CONFIG_TCC_BCHECK 0 /* enable bound checking code */
#endif
...
#define WAIT_SEM //TODO:wait_sem
#define POST_SEM //TODO:post_sem
#else
#define TCC_SEM(s)
#define WAIT_SEM(p)
#define POST_SEM(p)
