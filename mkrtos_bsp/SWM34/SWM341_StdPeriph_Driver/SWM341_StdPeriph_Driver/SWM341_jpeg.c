...
* ��������:	JPEG_Init()
* ����˵��: JPEG��������ʼ��
* ��    ��: JPEG_TypeDef * JPEGx	ָ��Ҫ�����õ�JPEG����������Чֵ����JPEG
*			JPEG_InitStructure * initStruct    ����JPEG����������趨ֵ�Ľṹ��
* ��    ��: ��
* ע������: ��
******************************************************************************************************************************************/
...
* ����˵��: JPEG����������
* ��    ��: JPEG_TypeDef * JPEGx	ָ��Ҫ�����õ�JPEG����������Чֵ����JPEG
*			jfif_info_t * jfif_info		Ҫ����ͼ�����Ϣ
*			jpeg_outset_t * jpeg_outset	��������趨
* ��    ��: ��
* ע������: ��
******************************************************************************************************************************************/
