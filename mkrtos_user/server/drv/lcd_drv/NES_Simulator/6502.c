...
//#endif 
	...
	//ÿ�δ��䣬��Ҫ512 cycles (about 4.5 scanlines worth)

	clockticks6502 -= 512;//����512CPUʱ������
...
////		 break;
   	case 0x2000:	//$2000 ~ $2FFF
		 return PPU_RegRead(addr&0x7);	/*PPU IO�ӿ�*/	
...
void put6502memory(WORD addr, BYTE value)
{
	switch(addr & 0xE000){
   	...
   	case 0x2000:	/*PPU IO�ӿ�*/
		 ...
		 break;
	case 0x4000:	/*APU �������� IO�ӿ� ��չROM*/
		 if(addr == 0x4014){
//#ifdef	_NES_DEBUG_
//			printf("\r\n SprDMAд��");
//#endif
			SprDMA(value);	   //value Ϊ��Ҫ���͵����ݵ�ַ�ĸ߰�λ
		 }
		 if(addr == 0x4016){   
			/*bit0 JoyPad ����*/
...
//	PC |= get6502memory(0xfffd & addrmask) << 8;
	PC  = get6502memory(0xfffc);  //��λ��ַ�����ж�ȡPC
