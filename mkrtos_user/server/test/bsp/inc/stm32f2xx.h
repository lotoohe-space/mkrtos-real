...
#define __STM32F2XX_STDPERIPH_VERSION ((__STM32F2XX_STDPERIPH_VERSION_MAIN << 24) | (__STM32F2XX_STDPERIPH_VERSION_SUB1 << 16) | (__STM32F2XX_STDPERIPH_VERSION_SUB2 << 8) | (__STM32F2XX_STDPERIPH_VERSION_RC))
