...
extern long syscall_backend(long sys_inx, ...);
#endif
...
#ifdef NO_LITTLE_MODE
	return syscall_backend(n, a, b, c);
#else
	return -ENOSYS;
#endif
}
...
#ifdef NO_LITTLE_MODE
	return syscall_backend(n, a, b, c, d);
#else
	return -ENOSYS;
#endif
}
...
#ifdef NO_LITTLE_MODE
	return syscall_backend(n, a, b, c, d, e);
#else
	return -ENOSYS;
#endif
}
...
#ifdef NO_LITTLE_MODE
	return syscall_backend(n, a, b, c, d, e, f);
#else
	return -ENOSYS;
#endif
}
