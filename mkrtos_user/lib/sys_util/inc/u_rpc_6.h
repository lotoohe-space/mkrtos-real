...
#define RPC_GENERATION_CALL6(is_fast, struct_type, prot, op, func_name,                                                                                                \
                             ...
                             cli_type5, svr_type5, dir5, rpc_type5, name5)                                                                                             \
    msg_tag_t struct_type##_##func_name##_call(obj_handler_t hd, cli_type0 *var0, cli_type1 *var1, cli_type2 *var2, cli_type3 *var3, cli_type4 *var4, cli_type5 *var5) \
    {                                                                                                                                                                  \
        void *buf;                                                                                                                                                     \
        ipc_msg_t *msg_ipc;                                                                                                                                            \
                                                                                                                                                                       \
        ...
        RPC_CLI_MSG_TO_BUF_IN(rpc_type5, cli_type5, var5, dir5, (uint8_t *)msg_ipc->msg_buf, off);                                                                     \
        ...
        RPC_CLI_BUF_TO_MSG_OUT(rpc_type5, cli_type5, var5, dir5, (uint8_t *)msg_ipc->msg_buf, off, tag.msg_buf_len *WORD_BYTES);                                       \
        return tag;                                                                                                                                                    \
    }

#define RPC_GENERATION_DISPATCH6(struct_type, prot, op, func_name,                                         \
                                 cli_type0, svr_type0, dir0, rpc_type0, name0,                             \
                                 cli_type1, svr_type1, dir1, rpc_type1, name1,                             \
                                 cli_type2, svr_type2, dir2, rpc_type2, name2,                             \
                                 cli_type3, svr_type3, dir3, rpc_type3, name3,                             \
    ...
    {                                                                                                      \
        ...
        RPC_TYPE_INIT_FUNC_CALL(svr_type5, &var5);                                                         \
                                                                                                           \
        /*取得op*/                                                                                         \
        ...
        RPC_SVR_BUF_TO_MSG_IN(rpc_type5, svr_type5, &var5, dir5, value, off, tag.msg_buf_len *WORD_BYTES); \
                                                                                                           \
        short ret_val = struct_type##_##func_name##_op(obj, &var0, &var1, &var2, &var3, &var4, &var5);     \
                                                                                                           \
        if (ret_val < 0)                                                                                   \
        {                                                                                                  \
        ...
        RPC_SVR_MSG_TO_BUF_OUT(rpc_type5, svr_type5, &var5, dir5, value, off);                             \
        ...
        PRC_SVR_FILL_MAP_BUF(rpc_type5, svr_type5, &var5, dir5, ipc_msg->map_buf, off_map);                \
        return msg_tag_init4(0, ROUND_UP(off, WORD_BYTES), ROUND_UP(off_map, WORD_BYTES), ret_val);        \
    }

#define RPC_GENERATION_OP6(struct_type, prot, op, func_name,             \
                           cli_type0, svr_type0, dir0, rpc_type0, name0, \
                           cli_type1, svr_type1, dir1, rpc_type1, name1, \
                           cli_type2, svr_type2, dir2, rpc_type2, name2, \
                           cli_type3, svr_type3, dir3, rpc_type3, name3, \
                           cli_type4, svr_type4, dir4, rpc_type4, name4, \
                           cli_type5, svr_type5, dir5, rpc_type5, name5) \
    short struct_type##_##func_name##_op(struct_type *obj, svr_type0 *name0, svr_type1 *name1, svr_type2 *name2, svr_type3 *name3, svr_type4 *name4, svr_type5 *name5)

#define RPC_GENERATION_OP_DISPATCH6(struct_type, prot, op, func_name,                                                                                                   \
                                    cli_type0, svr_type0, dir0, rpc_type0, name0,                                                                                       \
                                    cli_type1, svr_type1, dir1, rpc_type1, name1,                                                                                       \
                                    cli_type2, svr_type2, dir2, rpc_type2, name2,                                                                                       \
                                    cli_type3, svr_type3, dir3, rpc_type3, name3,                                                                                       \
                                    ...
                                    cli_type5, svr_type5, dir5, rpc_type5, name5)                                                                                       \
    short struct_type##_##func_name##_op(struct_type *obj, svr_type0 *name0, svr_type1 *name1, svr_type2 *name2, svr_type3 *name3, svr_type4 *name4, svr_type5 *name5); \
    RPC_GENERATION_DISPATCH6(struct_type, prot, op, func_name,                                                                                                          \
                             cli_type0, svr_type0, dir0, rpc_type0, name0,                                                                                              \
                             cli_type1, svr_type1, dir1, rpc_type1, name1,                                                                                              \
                             cli_type2, svr_type2, dir2, rpc_type2, name2,                                                                                              \
                             cli_type3, svr_type3, dir3, rpc_type3, name3,                                                                                              \
