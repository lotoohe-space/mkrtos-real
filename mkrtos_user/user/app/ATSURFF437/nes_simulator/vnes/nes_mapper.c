...
{
    map67_(page,nes_ram_offset) ;
}
void set_CPU_bank4(signed char page )
{
    map89_(page,nes_ram_offset) ;
}
void set_CPU_bank5(signed char page )
{
    mapAB_(page,nes_ram_offset) ;
}
void set_CPU_bank6(signed char page )
{
    mapCD_(page,nes_ram_offset) ;
}
void set_CPU_bank7(signed char page )
{
    mapEF_(page,nes_ram_offset) ;
}
void set_CPU_banks(int bank0_num, int bank1_num, int bank2_num, int bank3_num)
{
    map89_(bank0_num,nes_ram_offset);
    mapAB_(bank1_num,nes_ram_offset);
    mapCD_(bank2_num,nes_ram_offset);
    mapEF_(bank3_num,nes_ram_offset);
}
