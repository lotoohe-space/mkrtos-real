...
void map67_(signed char page, long ram_offset);  //6502.s
void map89_(signed char page, long ram_offset);  
void mapAB_(signed char page, long ram_offset);
void mapCD_(signed char page, long ram_offset);
void mapEF_(signed char page, long ram_offset);//有符号字符
