...
uint32_t __STREXB(uint8_t value, uint8_t *addr)
{
   ...
   //__ASM __volatile__ ("strexb %0, %2, [%1]" : "=r" (result) : "r" (addr), "r" (value) );
...
uint32_t __STREXH(uint16_t value, uint16_t *addr)
{
   ...
   //__ASM __volatile__ ("strexh %0, %2, [%1]" : "=r" (result) : "r" (addr), "r" (value) );
...
uint32_t __STREXW(uint32_t value, uint32_t *addr)
{
   ...
   __ASM __volatile__ ("strex %0, %2, [%1]" : "=r" (result) : "r" (addr), "r" (value) );
   return(result);
}
