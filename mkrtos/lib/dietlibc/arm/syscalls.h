...
#define __NR_subscribe_msg      (__NR_SYSCALL_BASE+400)
#define __NR_publish_msg        (__NR_SYSCALL_BASE+401)
#define __NR_msgreturn          (__NR_SYSCALL_BASE+402)
/*
...
#define __ARGS_subscribe_msg     0
#define __ARGS_publish_msg       0

#define __ARGS_msgreturn           0
#ifdef __ASSEMBLER__
