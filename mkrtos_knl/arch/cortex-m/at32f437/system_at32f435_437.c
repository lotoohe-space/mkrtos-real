...
/** @addtogroup AT32F435_437_system_private_defines
  * @{
  */
#define VECT_TAB_OFFSET                  (CONFIG_BOOTSTRAP_TEXT_SIZE + CONFIG_DTBO_TEXT_SIZE)  /*!< vector table base offset field. this value must be a multiple of 0x400. */
/**
  * @}
  */
...
void system_core_clock_update(void)
{
  ...
  switch(sclk_source)
  {
    ...
    case CRM_SCLK_PLL:
      ...
      system_core_clock = (uint32_t)(((uint32_t)pllrcsfreq * pll_ns) / (pll_ms * pll_fr));
      break;
    default:
      system_core_clock = HICK_VALUE;
      break;
