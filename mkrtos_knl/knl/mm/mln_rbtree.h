...
#define mln_rbtree_inline_insert(t, n, compare) ({           \
    ...
    if (y == nil)                                            \
        tree->root = (n);                                    \
    else if (compare((n)->data, y->data) < 0)                \
        y->left = (n);                                       \
    else                                                     \
        y->right = (n);                                      \
    (n)->left = (n)->right = nil;                            \
    ...
    if (tree->min == nil)                                    \
        tree->min = (n);                                     \
    else if (compare((n)->data, tree->min->data) < 0)        \
        tree->min = (n);                                     \
    ++(tree->nr_node);                                       \
...
extern mln_rbtree_t *mln_rbtree_init(struct mln_rbtree_attr *attr, mln_rbtree_t *t);
